#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Patio Language School sample weekly schedule grid (1080x1350) - days across top."""
...
# two time rows, one entry per day
SLOTS = [
...
.ampm{{font-size:22px;font-weight:700;letter-spacing:.14em;margin-top:8px;opacity:.82;}}
...
.qrlabel{{color:#726651;font-weight:700;font-size:20px;letter-spacing:.03em;}}
...
"""
    body = (f'<div class="canvas">'
        ...
        f'<div class="pline">Praça do Poder Local, Lote 14, Loja C &middot; 8600-524 Lagos</div>'
        f'</div></div>'
        f'</div>'
...
if __name__ == "__main__":
    render(build("schedule-sample-1080x1620.html"))
    print("done")
