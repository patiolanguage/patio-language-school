#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Patio Language School - Free Level Check promo, EUROPEAN PORTUGUESE (IG 1080x1350)."""
...
def build(fname):
    ticks = [
        "Sem teste &mdash; é só uma conversa",
        "Presencial ou por WhatsApp, 15 minutos",
        "O teu nível e a turma ideal para ti",
    ]
    lis = "".join(
...
.headline{{font-family:'DM Serif Display',serif;color:#FBF6EE;font-size:80px;line-height:1.04;}}
.headline .a{{color:#E0A868;font-style:italic;}}
.sub{{color:#F1E3CE;font-size:33px;font-weight:500;margin-top:24px;line-height:1.42;}}
...
.cta{{display:inline-block;background:#C19D5F;color:#2B1F18;font-weight:800;font-size:37px;
  padding:26px 52px;border-radius:60px;letter-spacing:.01em;}}
...
"""
    body = (f'<div class="canvas">'
        f'<div class="eyebrow">Antes de abrirmos &middot; Lagos</div>'
        f'<div class="badge">Grátis</div>'
        f'<div class="headline">Descobre o teu nível,<br><span class="a">grátis.</span></div>'
        f'<div class="sub">Uma conversa descontraída com a Sofia &mdash; descobre em que ponto estás e qual a turma certa para ti.</div>'
        f'<div class="list">{lis}</div>'
        f'<img class="photo" src="{SOFIA}">'
        f'<div class="contact">'
        f'<div class="cta">Fala connosco para marcar</div>'
...
if __name__ == "__main__":
    render(build("levelcheck-pt-ig-1080x1350.html"))
    print("done")
